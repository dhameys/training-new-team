<template>
    <div class="bg-gray-100 h-32 pt-5 pl-5 text-xl text-white font-mono">
        <h2 class="pt-10 text-black">Editor</h2>
    ...
    <form>
        <div class="w-full h-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            <div class=" bg-green-300 flex items-center justify-between px-3 py-2 border-b dark:border-gray-600">
                <div class="bg-white flex flex-wrap items-center divide-gray-200 sm:divide-x sm:rtl:divide-x-reverse dark:divide-gray-600">
                    <div class=" bg-white flex items-center space-x-1 rtl:space-x-reverse sm:pe-4">
                ...
                <div id="tooltip-fullscreen" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg  shadow-sm opacity-0 tooltip dark:bg-gray-700">
                    Show full screen
                    <div class="tooltip-arrow h-screen " data-popper-arrow></div>
                </div>
            </div>
            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800"> 
                <textarea id="editor" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="editor text try to enter texte" required></textarea>
            </div>
        </div>
